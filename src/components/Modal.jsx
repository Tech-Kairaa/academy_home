	...
	return (
		<div className={showHideClassName} tabIndex='-1' role='dialog'>
			<div className='modal-dialog modal-lg p-5'>
				<div className='modal-content mx-auto mt-50 p-10 bg-transparent border-0'>
					<span
						onClick={handleClose}
						className='bi bi-x fs-1 cursor-pointer position-absolute z-5 text-white rounded-circle'
